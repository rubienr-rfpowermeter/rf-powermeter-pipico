...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (495 * 1024U)         /**< [bytes] */
...
#define LV_ASSERT_HANDLER { printf("waiting for debugger ...\n"); fflush(stdout); while(true) { } }
...
#define LV_USE_PROFILER 0
    ...
    #define LV_PROFILER_INCLUDE "gitmodules/lvgl/src/misc/lv_profiler_builtin.h"
